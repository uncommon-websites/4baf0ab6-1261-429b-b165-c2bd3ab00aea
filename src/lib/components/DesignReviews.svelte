<script>
  ...
  const tabs = ['Assembly', 'Operator View', 'Analytics', 'Approval'];
</script>
...
<section class="py-24 bg-white text-center">
  <div class="max-w-[1200px] mx-auto px-6">
    ...
    <p class="text-lg text-gray-600 mb-16 max-w-2xl mx-auto leading-relaxed">
      Operators get clear, visual instructions on any device. Engineers can review and approve sequences before they hit production. Everyone stays on the same page.
    </p>
